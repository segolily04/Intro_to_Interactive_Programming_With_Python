...
ball_vel = [0, 0]
paddle1_pos = [WIDTH/4, HEIGHT/2]
paddle2_pos = [3*WIDTH/4, 3*HEIGHT/2]
paddle1_vel = [0, 0]
paddle2_vel = [0, 0]
score1 = 0
score2 = 0
...
def new_game():
    ...
    #update paddel positions
    paddle1_pos = HEIGHT/2
    paddle2_pos = HEIGHT/2
    
    #update paddel velocity
    paddle1_vel = 0
    paddle2_vel = 0
    
    #update scored to zero
    score1 = 0
    score2 = 0
...
def draw(canvas):
    ...
    #draw paddles
    canvas.draw_polygon([(0, paddle1_pos - HALF_PAD_HEIGHT), (0, paddle1_pos + HALF_PAD_HEIGHT), (PAD_WIDTH - 2, paddle1_pos + HALF_PAD_HEIGHT), (PAD_WIDTH - 2, paddle1_pos - HALF_PAD_HEIGHT)], PAD_WIDTH - 1, "Red", "White")
    canvas.draw_polygon([(WIDTH, paddle2_pos - HALF_PAD_HEIGHT), (WIDTH, paddle2_pos + HALF_PAD_HEIGHT), (WIDTH - PAD_WIDTH + 2, paddle2_pos + HALF_PAD_HEIGHT), (WIDTH - PAD_WIDTH + 2, paddle2_pos - HALF_PAD_HEIGHT)], PAD_WIDTH - 1, "Red", "White")
